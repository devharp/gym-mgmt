                    ...
                    <div className='position-absolute' style={{ marginTop: `calc(80/640 * 100vw)`, width: '100vw', backgroundColor: '#FBE551' }}>
                        <div className='d-flex justify-content-center' style={{ width: '100vw' }}>
                            <div className='' style={{ maxWidth: `calc(250/360 * 100vw)` }}>
                                ...
                                <div className='mb-3' style={{ fontSize: `calc(20/640 * 100vw)`, textAlign: 'center', textAlignLast: 'center' }}>We build this on a mission to make a regular fitness regime for all women at very affordable prices. We feel immensely proud to be renowned as India’s first women-only fitness online program training. Additionally, SuperGrl provides employment opportunities for unwaged fitness enthusiasts by offering them the career opportunity to become coaches.</div>
                                <div className='mb-3' style={{ fontSize: `calc(20/640 * 100vw)`, textAlign: 'center', textAlignLast: 'center' }}>At SuperGrl, we offer fitness coaching that is balanced in nature-for the body, mind, and spirit. No matter what kind of diet and exercise plan you're looking for or what type of mental wellness you're seeking, SuperGrl is flexible for you! You can reach your fitness goals faster with our unique methods and customised approach.</div>
                            </div>
                        </div>
