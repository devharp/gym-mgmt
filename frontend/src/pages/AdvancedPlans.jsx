            ...
            return (
                <>
                    <div className="position-relative d-flex flex-column align-items-center" style={{ width: '100%', paddingTop: `calc(200/1080 * ${props.bheight})` }}>
                        <div className='position-relative' style={{ letterSpacing: `calc(3.6/1080 * ${props.bheight})`, fontSize: `calc(36/1080 * ${props.bheight})`, fontWeight: '500' }}>Advanced Level</div>
                        <div className="position-relative" style={{ width: '100%', width: `calc(180/1080 * ${props.bheight})`, height: '2px', backgroundColor: '#04C7F4' }}></div>
                        <div className="flex-grow-1 d-flex flex-row align-items-center justify-content-center d-none" style={{ width: '100%', zIndex: '1' }}>
                        ...
                        <div className='mt-5 h1'>Coming Soon!</div>
                    </div>
                </>);
        }
        return (
        ...
        return (
            <>
                <div className="mt-5 pt-5 d-flex flex-column align-items-center">
                    <div className='mb-2' style={{ fontSize: `calc(18/640 * ${props.bheight})`, letterSpacing: `calc(1.8/640 * ${props.bheight})`, fontWeight: '500' }}>Advanced Level</div>
                    <div className='mb-5' style={{ backgroundColor: '#04C7F4', width: `calc(180/1080 * ${props.bheight})`, height: '3px' }}></div>
                    <div className='d-none' style={{ maxWidth: `calc(320px)`, textAlign: 'center', textAlignLast: 'center', fontSize: `cacl(14/640 * ${props.bheight})` }}>
                    ...
                    <div className="mt-5 position-relative d-none" style={{ width: '100%', height: 'max-content' }}>
                    ...
                    <div className='mt-5 h1 p-2' style={{ backgroundColor: 'white' }}>Coming Soon!</div>
                </div>
                <div className="position-absolute d-flex justify-content-between flex-grow-1" style={{ width: '100vw', height: '100vh' }}>
                    <div className='' style={{ height: '100%', width: `150px`, zIndex: '-1', overflow: 'hidden' }}>
                        <img src={img00} style={{ width: '600px', transform: `rotate(30deg) translateX(-380px) translateY(200px)` }} />
                    </div>
                    <div className="d-flex" style={{ right: '0', width: '130px', overflow: 'hidden' }}>
                        <img src={img01} style={{ width: '600px', transform: 'translate(-30px, 100px) rotate(-40deg)' }} />
                    </div>
                </div>
            </>);
    }
