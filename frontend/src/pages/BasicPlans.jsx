            ...
            return (
                <>
                    <div className="position-relative d-flex flex-column align-items-center" style={{ width: '100%', paddingTop: `calc(200/1080 * ${props.bheight})` }}>
                        <div className='position-relative' style={{ letterSpacing: `calc(3.6/1080 * ${props.bheight})`, fontSize: `calc(36/1080 * ${props.bheight})`, fontWeight: '500' }}>Basic Level</div>
        ...
        return (
            <>
                <div className="mt-5 pt-5 d-flex flex-column align-items-center">
                    <div className='mb-2' style={{ fontSize: `calc(18/640 * ${props.bheight})`, letterSpacing: `calc(1.8/640 * ${props.bheight})`, fontWeight: '500' }}>Basic Level</div>
